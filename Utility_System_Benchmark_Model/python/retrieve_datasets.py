...
def get_datasets():
    ...
    #retrieve project installation data fron NREL library
    print("Retrieving Project Installation data")

    # installation_data_url = "https://nrellibrary.nrel.gov/store/WoodMackenzie/2020/WM_USSMI_Q42020.xlsx"
    # installation_data_file_path = dataset_path + 'WM_USSMI_2020.xlsx'
    ...
    return cpi_annual_avg, spi_data, utility_installation_data, commercial_installation_data, residential_installation_data, labor_data, labor_data_year, labor_data_nat

def get_local_datasets():

    labor_data_year = 2021
    ...
    labor_data = pd.read_excel(dataset_path + 'bls_labor_database.xlsx' )
    labor_data_nat = pd.read_excel(dataset_path + 'bls_labor_database_national.xlsx' )
