...
1. In command prompt, navigate to the "python" folder within the "Utility System Benchmark Model" folder
	a. If you are already inside of the "Utility System Benchmark Model" folder, type and enter
		>cd python
	b. If you are not already inside "Utility System Benchmark Model" folder, type and enter the full path of the python folder
		ex. >cd "Documents\Solar\Models\Utility System Benchmark Model\python"
...
4. View the results in excel
	a. Go to the "Utility System Benchmark Model" folder in your file explorer
