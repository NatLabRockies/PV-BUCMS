...
2. Download the "Utility System Benchmark Model" folder from Box.
...
4. In Anaconda Prompt, navigate to the "Utility System Benchmark Model" folder wherever you saved it
	a. type "cd" and then a space, and then the path of where your model is saved
		ex. >cd "Documents\Solar\Models\Utility System Benchmark Model"
	b. Hit Enter
...
5. Install the "virtual environment" file
	...
	b. In command prompt type and enter:
		>conda env create -f solar_python_model.yml
